...
def run_experiment(empowerment):
    ...
    full_pilot_policy = FullPilotPolicy(base_dir, policy_path="data/2020-01-26-CopilotTraining/2020_01_26_CopilotTraining-1580106610765/full_pilot_policy.pkl")
   ...
   #     'noisy': 0.4,
    ...
    #noop_copilot_policy = CoPilotPolicy(base_dir,policy_path='data/2020-01-24-CopilotTraining/2020_01_24_CopilotTraining-1579930382677/co_deepq_noop_policy.pkl')
    #noisy_copilot_policy = CoPilotPolicy(base_dir,policy_path='data/2020-01-23-CopilotTraining/2020_01_23_CopilotTraining-1579826296120/co_deepq_noisy_policy.pkl')
    laggy_copilot_policy = CoPilotPolicy(base_dir,policy_path='data/2020-01-26-CopilotTraining/2020_01_26_CopilotTraining-1580104422990/co_deepq_laggy_policy.pkl')
    #sensor_copilot_policy = CoPilotPolicy(base_dir,policy_path='data/2020-01-23-CopilotTraining/2020_01_23_CopilotTraining-1579826296120/co_deepq_sensor_policy.pkl')
